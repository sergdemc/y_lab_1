...
class TestSubmenu:
    ...
    def test_create_submenu_with_existing_title(self, base_url, prepare_test_data):
    ...
    def test_read_submenu_with_invalid_id(self, base_url, prepare_test_data):
        session, menu, submenu = prepare_test_data
    ...
    def test_read_submenu_with_not_uuid_id(self, base_url, prepare_test_data):
        session, menu, submenu = prepare_test_data
        response = client.get(
    ...
    def test_update_submenu(self, base_url, prepare_test_data):
        session, menu, submenu = prepare_test_data
        submenu_data = {
    ...
    def test_update_submenu_with_invalid_id(self, base_url, prepare_test_data):
        session, menu, submenu = prepare_test_data
        invalid_id = 'c11907df-84fe-481c-94fa-fdc9fcab34b0'
        submenu_data = {
            "title": "updated submenu1",
    ...
    def test_update_submenu_with_invalid_menu_id(self, base_url, prepare_test_data):
        session, menu, submenu = prepare_test_data
        invalid_id = 'c11907df-84fe-481c-94fa-fdc9fcab34b0'
        submenu_data = {
            "title": "updated submenu1",
