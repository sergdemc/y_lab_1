...
class TestMenu:
    ...
    def test_read_empty_menus(self, get_app: FastAPI) -> None:
        response = client.get(
    ...
    def test_create_menu(self, get_app: FastAPI, get_db: Session) -> None:
        menu_data: dict = {
            'title': 'menu1',
            'description': 'description menu1'
        }
    ...
    def test_create_menu_with_existing_title(self, get_app: FastAPI, prepare_test_data: tuple[Session, Menu]) -> None:
    ...
    def test_read_menu(self, get_app: FastAPI, get_db: Session, prepare_test_data: tuple[Session, Menu]) -> None:
        session, menu = prepare_test_data
        response = client.get(
    ...
    def test_read_menu_with_invalid_id(self, get_app: FastAPI) -> None:
    ...
    def test_read_menu_with_not_uuid_id(self, get_app: FastAPI) -> None:
        response = client.get(
    ...
    def test_read_menus(self, get_app: FastAPI, prepare_test_data: tuple[Session, Menu]) -> None:
        session, menu = prepare_test_data
        response = client.get(
            url=get_app.url_path_for('read_menus')
        )
    ...
    def test_update_menu(self, get_app: FastAPI, get_db: Session, prepare_test_data: tuple[Session, Menu]) -> None:
        session, menu = prepare_test_data
        menu_data: dict = {
            'title': 'updated menu1',
    ...
    def test_update_menu_with_invalid_id(self, get_app: FastAPI) -> None:
        invalid_id: str = 'c11907df-84fe-481c-94fa-fdc9fcab34b0'
    ...
    def test_delete_menu(self, get_app: FastAPI, prepare_test_data: tuple[Session, Menu]) -> None:
        session, menu = prepare_test_data
